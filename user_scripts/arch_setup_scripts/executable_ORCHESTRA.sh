...
INSTALL_SEQUENCE=(
#    "U | 005_hypr_custom_config_setup.sh" # uncomment to regenerate hypr config
    "U | 010_package_removal.sh --auto" # uninstalls specified packages
    "U | 015_set_thunar_terminal_kitty.sh" 
    "U | 020_desktop_apps_username_setter.sh" 
#    "U | 025_configure_keyboard.sh" # already done
#    "U | 030_uwsm_env_comment_everything.sh --auto" # already done
#    "U | 035_configure_uwsm_gpu.sh" # cachyos
    "U | 040_long_sleep_timeout.sh --auto"
#    "S | 045_battery_limiter.sh" # laptop
#    "S | 050_pacman_config.sh" # cachyos
#    "S | 055_pacman_reflector.sh" # cachyos
    "S | 060_package_installation.sh"
    "U | 065_enabling_user_services.sh"
#    "S | 070_openssh_setup.sh --auto" # maybe useful
    "U | 075_changing_shell_zsh.sh"
    "S | 080_aur_paru_fallback_yay.sh --paru"
#    "S | 085_warp.sh"
#    "U | 090_paru_packages_optional.sh" # TODO review
...
#    "S | 120_create_mount_directories.sh" # do manually 
    "S | 125_pam_keyring.sh"
    "U | 130_copy_service_files.sh --default"
#    "U | 135_battery_notify_service.sh --auto" # laptop
    "U | 140_fc_cache_fv.sh"
    "U | 145_matugen_directories.sh"
#    "U | 150_wallpapers_download.sh" # dont need
...
#    "U | 240_swaync_dgpu_fix.sh --disable" # laptop
#    "S | 245_asusd_service_fix.sh"
#    "S | 250_ftp_arch.sh"
#    "U | 255_tldr_update.sh"
#    "U | 260_spotify.sh" #TODO view
#    "U | 265_mouse_button_reverse.sh --right"
#    "U | 270_neovim_clean.sh" #TODO view
#    "U | 275_neovim_lazy_sync.sh" #TODO view
#    "U | 280_dusk_clipboard_errands_delete.sh --delete" # run to clear clipboard
...
#    "S | 350_dns_systemd_resolve.sh" # cachyos
#    "U | 355_hyprexpo_plugin.sh"
#    "U | 360_obsidian_pensive_vault_configure.sh" # dont need
    "U | 365_cache_purge.sh"
#    "S | 370_arch_install_scripts_cleanup.sh"
    "U | 375_cursor_theme_bibata_classic_modern.sh"
#    "S | 380_nvidia_open_source.sh" # cachyos
#    "S | 385_waydroid_setup.sh"
    "U | 390_clipboard_persistance.sh --ram"
#    "S | 395_intel_media_sdk_check.sh" # only intel
#    "U | 400_firefox_matugen_pywalfox.sh"
#    "U | 405_spicetify_matugen_setup.sh" #TODO view
    "U | 410_waybar_swap_config.sh" #TODO modify
    "U | 415_mpv_setup.sh"
...
#    "U | 440_config_bat_notify.sh --default" laptop
...
#    "U | 470_vesktop_matugen.sh --auto" discord #TODO view
